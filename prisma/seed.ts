...
const achievements = [
  ...
  { slug: 'snake-first-bite', name: 'First Bite', description: 'Eat your first piece of food in Snake Arena.', xpReward: 50, coinReward: 10, category: 'gameplay', gameSlug: 'snake-arena' },
...
async function main() {
  ...
  const defaults = [
    ...
    { name: 'Cricket Chat Pack', type: 'CHAT_PACK' as const, priceCoins: 80, assetUrl: 'Cricket', isDefault: false, metadata: { messages: ['🏏 Well Played!', '🏏 What a Shot!', '🏏 Clean Bowled!', '🏏 Catch It!', '🏏 Six!!!', '🏏 Nice Defense!', '🏏 Lucky Escape!', '🏏 Great Match!'] } },
    ...
    { name: 'Romantic Dating Chat Pack', type: 'CHAT_PACK' as const, priceCoins: 120, assetUrl: 'Dating', isDefault: false, metadata: { messages: ['❤️ Hi There!', '❤️ Missed You', '❤️ Nice To See You', "❤️ You're Sweet", '❤️ Good Luck!', '❤️ Have Fun!', "❤️ You're Amazing!", '❤️ See You Soon!'] } },
    ...
    { name: 'Cosmic Title', type: 'TITLE' as const, priceCoins: 150, isDefault: false, metadata: { minWins: 0, description: 'Reach Level 15 reward' } },
    { name: 'Game Legend', type: 'TITLE' as const, priceCoins: 500, isDefault: false, metadata: { minWins: 100, description: 'Win 100 Matches reward' } },
    { name: 'Shadow Warrior', type: 'TITLE' as const, priceCoins: 80, isDefault: false, metadata: { description: 'Purchase in Store' } },
    { name: 'Speed Demon', type: 'TITLE' as const, priceCoins: 120, isDefault: false, metadata: { description: 'Solve Memory Match in 15s' } },
    ...
    { name: 'Cosmic Trail', type: 'EFFECT' as const, priceCoins: 200, isDefault: false, metadata: { description: 'Reach Level 15 reward' } },
    { name: 'Golden Aura', type: 'EFFECT' as const, priceCoins: 400, isDefault: false, metadata: { description: 'Reach Level 50 reward' } },
    { name: 'Rainbow Sparkles', type: 'EFFECT' as const, priceCoins: 150, isDefault: false, metadata: { description: 'Daily Rewards streak 7 reward' } },
    { name: 'Thunder Effect', type: 'EFFECT' as const, priceCoins: 300, isDefault: false, metadata: { description: 'Open in Rare Mystery Crate' } },
    ...
    { name: 'Neon Frame', type: 'AVATAR_FRAME' as const, priceCoins: 100, isDefault: false, metadata: { minLevel: 5, description: 'Reach Level 5 reward' } },
    { name: 'Prestige Border', type: 'AVATAR_FRAME' as const, priceCoins: 250, isDefault: false, metadata: { minLevel: 10, description: 'Reach Level 10 reward' } },
    { name: 'Ruby Glow', type: 'AVATAR_FRAME' as const, priceCoins: 350, isDefault: false, metadata: { minLevel: 25, description: 'Reach Level 25 reward' } },
    { name: 'Champion Frame', type: 'AVATAR_FRAME' as const, priceCoins: 450, isDefault: false, metadata: { minLevel: 0, description: 'Win 50 Matches reward' } },
