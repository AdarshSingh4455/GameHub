...
exports.SCRIBBLE_WORDS = words_1.LOCAL_CATEGORIES.Animals;
/**
...
function popWordsFromQueue(state) {
    ...
    if (!state.unusedWords || state.unusedWords.length < 4) {
        ...
        const fallbackList = words_1.LOCAL_CATEGORIES[category] || words_1.LOCAL_CATEGORIES.Animals;
...
async function processScribbleMove(roomCode, roomId, userId, move, players, prisma, io) {
    ...
    if (type === 'settings') {
        ...
        const localWords = words_1.LOCAL_CATEGORIES[category] || words_1.LOCAL_CATEGORIES.Animals;
