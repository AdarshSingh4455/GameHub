      ...
      >
        {(isFullscreen) => (
          <>
            ...
            {!['cricket', 'scribble', 'ttt', 'memory', 'fighter', '2048', 'iframe', 'rps', 'numguess', 'arrowpuzzle', 'colorsort', 'unblocktraffic', 'waterconnect', 'dotsboxes', 'blockblast', 'neontetris', 'wordwizard'].includes(game.componentName) && (
